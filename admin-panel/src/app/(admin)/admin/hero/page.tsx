  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Control the homepage hero heading, buttons, fallback image, and premium background overlay from Firestore content/hero. For multiple real hospital slider images, use Media Library and choose section Hero."
      />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            Those hero media items now drive the homepage hero image slider. The background image field here works as the safe fallback when no hero slides are available.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
